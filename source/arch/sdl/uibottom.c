...
uikbd_key uikbd_keypos[] = {
	...
	// F-Keys
	{ 201,  1,  30,  20, 133,   0,   4,   0,  0,  "F1"}, // F1 / F2
	{ 231,  1,  30,  20, 134,   0,   5,   0,  0,  "F3"}, // F3 / F4
	{ 261,  1,  30,  20, 135,   0,   6,   0,  0,  "F5"}, // F5 / F6
	{ 291,  1,  29,  20, 136,   0,   3,   0,  0,  "F7"}, // F7 / F8
	// top row	
	...
	{ 281,101,  20,  19,  17,   0,   2,   0,  0,  "C_DOWN"}, // UP
