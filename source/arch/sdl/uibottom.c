...
int uikbd_pos[4][4] = {
	{0,0,320,155},		// normal keys
	{0,155,320,155},	// shifted keys
	{0,310,320,155},	// cbm keys
	{0,465,320,155}		// ctrl keys
};

uikbd_key uikbd_keypos[] = {
	//  x,  y,   w,   h, key, row, col, sticky, name
	// F-Keys
	{ 201, 29,  30,  20, 133,   0,   4,   0, "F1"}, // F1 / F2
	{ 231, 29,  30,  20, 134,   0,   5,   0, "F3"}, // F3 / F4
	{ 261, 29,  30,  20, 135,   0,   6,   0, "F5"}, // F5 / F6
	{ 291, 29,  29,  20, 136,   0,   3,   0, "F7"}, // F7 / F8
	// top row	
	{   1, 49,  20,  20,  95,   7,   1,   0, "ArrowLeft"}, // <-
	{  21, 49,  20,  20,  49,   7,   0,   0, "1"}, // 1 / !
	{  41, 49,  20,  20,  50,   7,   3,   0, "2"}, // 2 / "
	{  61, 49,  20,  20,  51,   1,   0,   0, "3"}, // 3 / #
	{  81, 49,  20,  20,  52,   1,   3,   0, "4"}, // 4 / $
	{ 101, 49,  20,  20,  53,   2,   0,   0, "5"}, // 5 / %
	{ 121, 49,  20,  20,  54,   2,   3,   0, "6"}, // 6 / &
	{ 141, 49,  20,  20,  55,   3,   0,   0, "7"}, // 7 / '
	{ 161, 49,  20,  20,  56,   3,   3,   0, "8"}, // 8 / (
	{ 181, 49,  20,  20,  57,   4,   0,   0, "9"}, // 9 / )
	{ 201, 49,  20,  20,  48,   4,   3,   0, "0"}, // 0 / 0
	{ 221, 49,  20,  20,  43,   5,   0,   0, "+"}, // + / +
	{ 241, 49,  20,  20,  45,   5,   3,   0, "-"}, // - / |
	{ 261, 49,  20,  20,  92,   6,   0,   0, "Pound"}, // Pound / ..
	{ 281, 49,  20,  20,  19,   6,   3,   0, "CLR"}, // CLR/HOME
	{ 301, 49,  19,  20,  20,   0,   0,   0, "INST"}, // INST/DEL
	// 2nd row	
	{   1, 69,  30,  20,  24,   7,   2,   4, "CTRL"}, // CTRL - sticky ctrl
	{  31, 69,  20,  20, 113,   7,   6,   0, "Q"}, // Q
	{  51, 69,  20,  20, 119,   1,   1,   0, "W"}, // W
	{  71, 69,  20,  20, 101,   1,   6,   0, "E"}, // E
	{  91, 69,  20,  20, 114,   2,   1,   0, "R"}, // R
	{ 111, 69,  20,  20, 116,   2,   6,   0, "T"}, // T
	{ 131, 69,  20,  20, 121,   3,   1,   0, "Y"}, // Y
	{ 151, 69,  20,  20, 117,   3,   6,   0, "U"}, // U
	{ 171, 69,  20,  20, 105,   4,   1,   0, "I"}, // I
	{ 191, 69,  20,  20, 111,   4,   6,   0, "O"}, // O
	{ 211, 69,  20,  20, 112,   5,   1,   0, "P"}, // P
	{ 231, 69,  20,  20,  64,   5,   6,   0, "@"}, // @
	{ 251, 69,  20,  20,  42,   6,   1,   0, "*"}, // *
	{ 271, 69,  20,  20,  94,   6,   6,   0, "ArrowUp"}, // ^| / π
	{ 291, 69,  29,  20,  25,  -3,   0,   0, "RESTORE"}, // RESTORE
	// 3rd row	
	{   1, 89,  20,  20,   3,   7,   7,   0, "R/S"}, // RUN/STOP
	{  21, 89,  20,  20,  21,   1,   7,   1, "S/L"}, // SHIFT LOCK - sticky shift
	{  41, 89,  20,  20,  97,   1,   2,   0, "A"}, // A
	{  61, 89,  20,  20, 115,   1,   5,   0, "S"}, // S
	{  81, 89,  20,  20, 100,   2,   2,   0, "D"}, // D
	{ 101, 89,  20,  20, 102,   2,   5,   0, "F"}, // F
	{ 121, 89,  20,  20, 103,   3,   2,   0, "G"}, // G
	{ 141, 89,  20,  20, 104,   3,   5,   0, "H"}, // H
	{ 161, 89,  20,  20, 106,   4,   2,   0, "J"}, // J
	{ 181, 89,  20,  20, 107,   4,   5,   0, "K"}, // K
	{ 201, 89,  20,  20, 108,   5,   2,   0, "L"}, // L
	{ 221, 89,  20,  20,  58,   5,   5,   0, ":"}, // : / [
	{ 241, 89,  20,  20,  59,   6,   2,   0, ";"}, // ; / ]
	{ 261, 89,  20,  20,  61,   6,   5,   0, "="}, // =
	{ 281, 89,  39,  20,  13,   0,   1,   0, "CR"}, // RETURN
	// 4th row	
	{   1,109,  20,  20,  23,   7,   5,   2, "C="}, // cbm - sticky cbm
	{  21,109,  30,  20,  21,   1,   7,   1, "LSHIFT"}, // LSHIFT - sticky shift
	{  51,109,  20,  20, 122,   1,   4,   0, "Z"}, // Z
	{  71,109,  20,  20, 120,   2,   7,   0, "X"}, // X
	{  91,109,  20,  20,  99,   2,   4,   0, "C"}, // C
	{ 111,109,  20,  20, 118,   3,   7,   0, "V"}, // V
	{ 131,109,  20,  20,  98,   3,   4,   0, "B"}, // B
	{ 151,109,  20,  20, 110,   4,   7,   0, "N"}, // N
	{ 171,109,  20,  20, 109,   4,   4,   0, "M"}, // M
	{ 191,109,  20,  20,  44,   5,   7,   0, ","}, // ,
	{ 211,109,  20,  20,  46,   5,   4,   0, "."}, // .
	{ 231,109,  20,  20,  47,   6,   7,   0, "/"}, // /
	{ 251,109,  30,  20,  21,   6,   4,   1, "RSHIFT"}, // RSHIFT - sticky shift
	// SPACE	
	{  61,129, 180,  20,  32,   7,   4,   0, "SPACE"},  // SPACE
	// Cursor Keys
	{ 281,109,  20,  20,  30,   0,   7,   0, "C_UP"}, // DOWN
	{ 301,129,  19,  20,  29,   0,   2,   0, "C_RIGHT"}, // RIGHT
	{ 281,129,  20,  20,  17,   0,   2,   0, "C_DOWN"}, // UP
	{ 261,129,  20,  20,  31,   0,   2,   0, "C_LEFT"}, // LEFT
	// Finish
	{   0,  0,   0,   0,   0,   0,   0,   0, ""}
};
