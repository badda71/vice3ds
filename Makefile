...
CFLAGS		:=	-ggdb -Wall -Wno-stringop-truncation -Wno-format-truncation -O3 -mword-relocations \
...
LIBS		:=	-lcurl -lmbedtls -lmbedx509 -lmbedcrypto -lpng -lz -lcitro3d -lctru -lm
